...
<div class="block full">
    ...
    <form action="{{ route('media.photos.store') }}" method="post" class="form-bordered" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group form-actions">
            ...
            <a href="{{ route('media.photos.index') }}" class="btn btn-sm btn-warning"><i class="fa fa-repeat"></i> {{
