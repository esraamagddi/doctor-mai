...
<div class="block full">
    <div class="block-title d-flex align-items-center justify-content-between">
        ...
        <div class="block-options pull-right">
            <a href="{{ route('media.photos.create') }}" class="btn btn-sm btn-primary">
                ...
                @foreach($items as $row)
                    <tr draggable="true" data-id="{{ $row->id }}">
                        ...
                        <td class="text-center">
                            <form action="{{ route('media.photos.toggle', $row) }}" method="post" class="d-inline toggle-form">
                                @csrf
                                @if($row->status)
                        ...
                        <td class="text-end">
                            <div class="btn-group" role="group">
                                <a href="{{ route('media.photos.edit', $row) }}" class="btn btn-sm btn-warning"
                            ...
                            <div class="btn-group" role="group">
                                <form action="{{ route('media.photos.destroy', $row) }}" method="post"
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.getElementById('saveOrderBtn')?.addEventListener('click', async () => {
    ...
    try {
      const res = await fetch(@json(route('media.photos.order', [], false)), {
        method: 'POST',
