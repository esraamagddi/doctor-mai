...
<div class="block full">
    ...
    <form action="{{ route('media.video_categories.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group form-actions">
            <button type="submit" class="btn btn-sm btn-primary"><i class="fa fa-save"></i> {{ __('media::messages.save') }}</button>
