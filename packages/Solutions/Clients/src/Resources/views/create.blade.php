...
@push('title') {{ __('clients::messages.title') }} - {{ __('clients::messages.add') }} @endpush
...
<ul class="breadcrumb breadcrumb-top">
    ...
    <li>{{ __('clients::messages.add') }}</li>
</ul>

<div class="block full">
    <div class="block-title d-flex align-items-center justify-content-between">
        <h2 class="m-0"><strong>{{ __('clients::messages.add') }}</strong></h2>
    ...
    <form action="{{ route('clients.store') }}" method="post" class="form-bordered" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group form-actions mt-3">
            <button type="submit" class="btn btn-sm btn-primary"><i class="fa fa-save"></i> {{ __('clients::messages.save') }}</button>
