...
@push('title')
  {{ __('appointments::messages.timeslots') }} - {{ __('appointments::messages.add_timeslot') }}
@endpush
...
@section('content')
  <ul class="breadcrumb breadcrumb-top">
    ...
    <li>{{ __('appointments::messages.add_timeslot') }}</li>
  </ul>

  <div class="block full">
    <div class="block-title">
      <h2 class="m-0">{{ __('appointments::messages.add_timeslot') }}</h2>
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="form-group">
            ...
            <select class="form-control" name="weekday">
              @for($i=1; $i<=7; $i++)
                <option value="{{ $i }}" {{ old('weekday') == $i ? 'selected' : '' }}>
        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input class="form-control" type="time" name="start_time" value="{{ old('start_time','09:00') }}">
          </div>
        </div>
        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input class="form-control" type="time" name="end_time" value="{{ old('end_time','17:00') }}">
          </div>
        </div>
        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input class="form-control" type="number" min="1" name="capacity" value="{{ old('capacity',1) }}">
          </div>
        </div>
