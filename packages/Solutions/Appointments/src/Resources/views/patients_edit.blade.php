...
@push('title')
  {{ __('appointments::messages.patients') }} - {{ __('appointments::messages.edit_patient') }}
@endpush
...
@section('content')
  <ul class="breadcrumb breadcrumb-top">
    ...
    <li>{{ __('appointments::messages.edit_patient') }}</li>
  </ul>

  <div class="block full">
    <div class="block-title">
      <h2 class="m-0">{{ __('appointments::messages.edit_patient') }}</h2>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input class="form-control" name="name[ar]" value="{{ old('name.ar', $patient->name['ar'] ?? '') }}">
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input class="form-control" name="name[en]" value="{{ old('name.en', $patient->name['en'] ?? '') }}">
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input class="form-control" name="phone" value="{{ old('phone', $patient->phone) }}">
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input class="form-control" type="date" name="birthdate"
                   value="{{ old('birthdate', optional($patient->birthdate)->format('Y-m-d')) }}">
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input class="form-control" name="file_number" value="{{ old('file_number', $patient->file_number) }}">
          </div>
        </div>
        ...
        <div class="col-md-12">
          <div class="form-group">
            ...
            <textarea class="form-control" name="notes" rows="4">{{ old('notes', $patient->notes) }}</textarea>
          </div>
        </div>
