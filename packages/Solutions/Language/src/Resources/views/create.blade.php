...
<ul class="breadcrumb breadcrumb-top">
    ...
    <li>{{ __('language::messages.add') }}</li>
</ul>
...
<div class="block full">
    ...
    <form action="{{ route('language.store') }}" method="post" class="form-bordered">
        @csrf
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control"
                           ...
                           placeholder="Arabic / English / Français">
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select name="dir" class="form-control">
                        <option value="ltr" {{ old('dir')=='ltr'?'selected':'' }}>LTR</option>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="locale" class="form-control"
                           value="{{ old('locale') }}" placeholder="en_US, ar_EG">
                </div>
            </div>
