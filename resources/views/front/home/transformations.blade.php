      ...
      <div class="order-1 space-y-8 lg:order-2">
        ...
        <div class="space-y-4">
          <h2 class="text-4xl font-bold leading-tight text-gray-900 md:text-5xl capitalize">
            {{ getLocalized(getSectionHeaders('transformations')['title']) ?? '' }}
          </h2>
          <div class="space-y-4 leading-relaxed text-gray-600">
            {{ getLocalized(getSectionHeaders('transformations')['description']) ?? '' }}
          </div>
        </div>
        ...
        <div class="flex-col hidden space-y-6 lg:flex">
          ...
          <div class="pt-8 border-t border-gray-200">
            <p class="text-gray-600">
              <span class="font-semibold text-gray-900">{{ __('appointment.no_insurance') }}</span>
            </p>
          </div>
        </div>
      </div>
