  ...
  <nav
    ...
    <div class="flex items-center gap-2 lg:hidden">
      ...
      <button onclick="window.location.href='index-ar.html'"
        class="flex items-center gap-2 text-sm font-medium text-primary cursor-pointer p-2 transition-all duration-300 rounded-full hover:bg-white/10 touch-manipulation">
        AR
      ...
      <button id="mobile-menu-button"
        class="p-2 text-primary transition-all duration-300 rounded-full hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white/30 group touch-manipulation"
