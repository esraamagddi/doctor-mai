<?php $__env->startPush('title'); ?> <?php echo e(__('blog::messages.categories')); ?> <?php $__env->stopPush(); ?>

<?php $__env->startPush('styles'); ?>
<style>
.table-responsive { overflow-x:auto; }
#categoriesTable tbody tr[draggable="true"] { cursor: move; }
#categoriesTable tbody tr.dragging { opacity: .5; }
</style>
<?php $__env->stopPush(); ?>
...
<ul class="breadcrumb breadcrumb-top">
    ...
    <li><?php echo e(__('blog::messages.categories')); ?></li>
</ul>

<div class="block full">
    <div class="block-title d-flex align-items-center justify-content-between">
        <h2 class="m-0"><strong><?php echo e(__('blog::messages.categories')); ?></strong></h2>
        <div class="block-options pull-right">
            <a href="<?php echo e(route('blog.categories.create')); ?>" class="btn btn-sm btn-success">
    ...
    <table class="table table-bordered table-striped" id="categoriesTable">
        <thead class="table-light">
            <tr>
                ...
                <th><?php echo e(__('blog::messages.name_en')); ?></th>
                <th><?php echo e(__('blog::messages.parent')); ?></th>
        ...
        <tbody id="sortableBody">
            ...
            <tr draggable="true" data-id="<?php echo e($item->id); ?>">
                ...
                <td><?php echo e(data_get($item->name,'en') ?? '-'); ?></td>
                <td><?php echo e(optional($item->parent)->name['en'] ?? '-'); ?></td>
                <td class="text-center">
                    <form action="<?php echo e(route('blog.categories.toggle',$item)); ?>" method="post" class="d-inline toggle-form">
                        <?php echo csrf_field(); ?>
                        <?php if($item->status): ?>
                ...
                <td class="text-center">
                    <input type="number" class="form-control form-control-sm order-input mx-auto"
                        ...
                        aria-label="<?php echo e(__('blog::messages.category_order')); ?>">
                </td>
                <td class="text-end">
                    <div class="btn-group" role="group">
                        <a href="<?php echo e(route('blog.categories.edit',$item)); ?>" class="btn btn-sm btn-warning" data-bs-toggle="tooltip" title="<?php echo e(__('blog::messages.edit')); ?>">
                            <i class="fa fa-pencil"></i>
                        </a>
                    </div>
                    <div class="btn-group" role="group">
                        <form action="<?php echo e(route('blog.categories.destroy',$item)); ?>" method="post" onsubmit="return confirm('<?php echo e(__('blog::messages.delete_confirm')); ?>')">
                            <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                            <button type="submit" class="btn btn-sm btn-danger" data-bs-toggle="tooltip" title="<?php echo e(__('blog::messages.delete')); ?>">
...
<div class="d-flex flex-column flex-md-row align-items-center justify-content-between small text-muted mt-2">
    <div class="mb-2 mb-md-0">
        ...
        <?php echo e(__('blog::messages.of')); ?> <strong><?php echo e($items->total()); ?></strong>
    </div>
    <div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    saveBtn.addEventListener('click', async () => {
        ...
        try {
            const res = await fetch(<?php echo json_encode(route('blog.categories.order', [], false)) ?>, {
                method: 'POST',
            ...
            saveBtn.innerHTML = '<i class="fa fa-check me-1"></i> <?php echo e(__('blog::messages.saved')); ?>';
            setTimeout(() => saveBtn.innerHTML = old, 1500);
        } catch (e) {
            alert('<?php echo e(__('blog::messages.save_failed')); ?>');
            console.error(e);
            saveBtn.disabled = false;
        }
    });
...
<?php echo $__env->make('core::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Dr-Mai-El-Hakim\packages\Solutions\Blog\src\Providers/../Resources/views/categories/index.blade.php ENDPATH**/ ?>