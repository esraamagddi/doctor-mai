<?php $__env->startPush('title'); ?> <?php echo e(__('media::messages.photos')); ?> <?php $__env->stopPush(); ?>
...
<div class="block full">
    <div class="block-title d-flex align-items-center justify-content-between">
        <h2 class="m-0"><strong><?php echo e(__('media::messages.photos')); ?></strong></h2>
        <div class="block-options pull-right">
            <a href="<?php echo e(route('media.photos.create')); ?>" class="btn btn-sm btn-primary">
                ...
                <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr draggable="true" data-id="<?php echo e($row->id); ?>">
                        ...
                        <td class="text-center">
                            <form action="<?php echo e(route('media.photos.toggle', $row)); ?>" method="post" class="d-inline toggle-form">
                                <?php echo csrf_field(); ?>
                                <?php if($row->status): ?>
                        ...
                        <td class="text-end">
                            <div class="btn-group" role="group">
                                <a href="<?php echo e(route('media.photos.edit', $row)); ?>" class="btn btn-sm btn-warning"
                            ...
                            <div class="btn-group" role="group">
                                <form action="<?php echo e(route('media.photos.destroy', $row)); ?>" method="post"
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.getElementById('saveOrderBtn')?.addEventListener('click', async () => {
    ...
    try {
      const res = await fetch(<?php echo json_encode(route('media.photos.order', [], false)) ?>, {
        method: 'POST',
...
<?php echo $__env->make('core::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Dr-Mai-El-Hakim\packages\Solutions\Media\src\Providers/../Resources/views/photos/index.blade.php ENDPATH**/ ?>