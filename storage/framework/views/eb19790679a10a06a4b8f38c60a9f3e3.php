...
<ul class="breadcrumb breadcrumb-top">
    ...
    <li><?php echo e(__('services::messages.add')); ?></li>
</ul>
...
<div class="block full">
    ...
    <form action="<?php echo e(route('services.store')); ?>" method="post" class="form-bordered" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
                ...
                <div class="tab-pane <?php echo e($lang->code === $activeLocale ? 'active' : ''); ?>" id="tab-<?php echo e($lang->code); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description[<?php echo e($lang->code); ?>]" class="form-control" rows="3" id="editor-description-<?php echo e($lang->code); ?>"
                                  placeholder="<?php echo e(__('services::messages.enter_description_'.$lang->code)); ?>"><?php echo e(old('description.'.$lang->code)); ?></textarea>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="url" name="link" class="form-control" value="<?php echo e(old('link')); ?>" placeholder="<?php echo e(__('services::messages.enter_link')); ?>">
                </div>
            </div>
                ...
                <div class="form-group">
                    ...
                    <div>
                        ...
                        <label class="switch switch-danger" style="vertical-align: middle;">
                            <input type="checkbox" name="status" value="1" <?php echo e(old('status', 1) ? 'checked' : ''); ?>>
                            <span></span>
                        </label>
        ...
        <div class="form-group form-actions mt-3">
            <button type="submit" class="btn btn-sm btn-primary"><i class="fa fa-save"></i> <?php echo e(__('services::messages.save')); ?></button>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('core::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Dr-Mai-El-Hakim\packages\Solutions\Services\src\Providers/../Resources/views/create.blade.php ENDPATH**/ ?>