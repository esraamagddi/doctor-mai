<?php $__env->startPush('title'); ?>
  <?php echo e(__('appointments::messages.title')); ?> - <?php echo e(__('appointments::messages.edit')); ?>
...
<?php $__env->startSection('content'); ?>
  <ul class="breadcrumb breadcrumb-top">
    ...
    <li><?php echo e(__('appointments::messages.edit')); ?></li>
  </ul>

  <div class="block full">
    <div class="block-title">
      <h2 class="m-0"><?php echo e(__('appointments::messages.edit')); ?></h2>
    ...
    <form method="POST" action="<?php echo e(route('appointments.update', $appointment->id)); ?>">
      ...
      <div class="row">
          ...
          <div class="form-group">
            ...
            <select name="patient_id" class="form-control">
              <?php $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($p->id); ?>" <?php echo e(old('patient_id', $appointment->patient_id) == $p->id ? 'selected' : ''); ?>>
          ...
          <div class="form-group">
            ...
            <select name="service_id" class="form-control">
              ...
              <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($s->id); ?>" <?php echo e(old('service_id', $appointment->service_id) == $s->id ? 'selected' : ''); ?>>
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <input type="date" name="preferred_date"
              value="<?php echo e(old('preferred_date', optional($appointment->preferred_date)->format('Y-m-d'))); ?>"
              class="form-control">
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <input type="time" name="preferred_time"
              value="<?php echo e(old('preferred_time', $appointment->preferred_time)); ?>"
              class="form-control">
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="form-group">
            <label class="control-label"><?php echo e(__('appointments::messages.status')); ?></label>
            <select name="status" class="form-control">
              <?php $__currentLoopData = ['pending', 'confirmed', 'completed', 'canceled', 'no_show']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($st); ?>" <?php echo e(old('status', $appointment->status) == $st ? 'selected' : ''); ?>>
        ...
        <div class="col-md-12">
          <div class="form-group">
            ...
            <textarea name="notes" class="form-control" rows="4"><?php echo e(old('notes', $appointment->notes)); ?></textarea>
          </div>
        </div>
      </div>
...
<?php echo $__env->make('core::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Dr-Mai-El-Hakim\packages\Solutions\Appointments\src\Providers/../Resources/views/edit.blade.php ENDPATH**/ ?>