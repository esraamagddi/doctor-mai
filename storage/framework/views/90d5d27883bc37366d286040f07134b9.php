        ...
        <div class="grid grid-cols-1 gap-12 lg:grid-cols-2">
            ...
            <div class="p-6 shadow-inner bg-base/40 backdrop-blur-lg rounded-2xl">
                ...
                <form class="space-y-6" method="POST" action="<?php echo e(route('front.contact.store')); ?>">
                    ...
                    <div>
                        <label for="name" class="block mb-2 text-sm font-medium text-gray-700"><?php echo e(__('contact.full_name')); ?></label>
                        <input type="text" id="name" name="name"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary"
                            value="<?php echo e(old('name')); ?>" required placeholder="<?php echo e(__('contact.full_name_placeholder')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        <label for="email" class="block mb-2 text-sm font-medium text-gray-700"><?php echo e(__('contact.email')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        <label for="phone" class="block mb-2 text-sm font-medium text-gray-700"><?php echo e(__('contact.phone')); ?></label>
                        <input type="tel" id="phone" name="phone" value="<?php echo e(old('email')); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        <label for="message" class="block mb-2 text-sm font-medium text-gray-700"><?php echo e(__('contact.message')); ?></label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Work\corpintech\Dr. Mai El-Hakim\resources\views/front/contact/index.blade.php ENDPATH**/ ?>