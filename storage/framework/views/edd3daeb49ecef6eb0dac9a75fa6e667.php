            ...
            <div class="order-1 lg:order-2">
                <div class="relative w-full">
                    ...
                    <div class="relative w-full h-72 sm:h-96 lg:h-screen  overflow-hidden ">
                        <img src="<?php echo e(asset('storage/' . $record->image)); ?>" alt=" <?php echo e(getLocalized($record->name) ?? ''); ?>"
    ...
    <div class="container px-6 mx-auto max-w-7xl">
        <div class="mb-16 text-center">
            ...
            <p class="max-w-2xl mx-auto text-lg text-gray-600">
                <?php echo e($aboutUs->education_description[app()->getLocale()] ?? ''); ?>
        ...
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="p-8 bg-white shadow-lg rounded-2xl">
                <div class="flex items-center mb-4">
                    <div class="flex items-center justify-center w-20 aspect-square mr-4 rounded-full bg-secondary">
            ...
            <!-- Repeat for other cards with dynamic data -->
        </div>
    </div>
</section>
        ...
        <div class="grid gap-16 lg:grid-cols-2">
            ...
            <div class="space-y-6">
                <h2 class="text-3xl font-bold text-gray-900 md:text-4xl">
                    <?php echo e($aboutUs->experience_years ?? ''); ?> Years of Excellence
                </h2>
                <div class="space-y-4">
                    <div class="flex items-start space-x-4">
                        <div class="flex items-center justify-center flex-shrink-0 w-8 h-8 mt-1 rounded-full bg-secondary">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">
                                <?php echo e($aboutUs->treatment_techniques[app()->getLocale()] ?? ''); ?>

                            </p>
                        </div>
                    </div>
                    <!-- Repeat for other experience points -->
                </div>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="p-6 border-l-4 border-primary bg-ternary/30">
                    <blockquote class="text-lg italic text-gray-700">
                        "<?php echo e($aboutUs->philosophy_quote[app()->getLocale()] ?? ''); ?>"
                    </blockquote>
                    <cite class="block mt-4 text-sm font-semibold text-primary">- <?php echo e($aboutUs->philosophy_author[app()->getLocale()] ?? ''); ?></cite>
                </div>
            </div>
        </div>
    </div>
...
<section class="py-24 bg-gradient-to-br from-secondary to-base">
    <div class="container max-w-4xl px-6 mx-auto text-center">
        <h2 class="mb-6 text-3xl font-bold text-primary md:text-4xl">
            Ready to Start Your Journey to Healthy, Radiant Skin?
        </h2>
        <p class="mb-8 text-lg text-primary md:text-xl">
            Schedule your consultation today and discover how Dr. Mai El-Hakim can
            help you achieve the healthy, radiant skin and natural beauty you
            deserve.
        </p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Work\corpintech\Dr. Mai El-Hakim\resources\views/front/aboutus/index.blade.php ENDPATH**/ ?>