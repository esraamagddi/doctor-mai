...
<?php
$bg = $record->{'background_'.app()->getLocale()}
?? $record->background_en
?? $record->background_ar;
?>
    ...
    <div class="flex items-end justify-center w-full px-4 lg:flex-1 lg:items-start lg:pt-16 md:justify-end rtl:justify-start max-w-7xl m-auto lg:pb-10">
        ...
        <div class="w-full max-w-md text-left lg:hero-content sm:max-w-md xl:max-w-2xl pb-10 ">
            ...
            <div class="flex-col justify-center hidden w-full gap-3 mt-5 lg:flex lg:flex-row lg:justify-start sm:gap-4 lg:gap-6">
                <?php
                $button1 = getLocalized($record->button1_text);
                $button1Text = $button1 ?? null;
                ?>
                ...
                <?php
                $button2 = getLocalized($record->button2_text);
    ...
    <div class="flex justify-center w-full px-4 mb-12 lg:mb-16">
        <div class="grid w-full max-w-7xl gap-6 lg:grid-cols-3">
            ...
            <a href="ContactUs.html"
                class="relative block p-6 sm:p-8 rounded-2xl shadow-lg border border-primary/20 bg-secondary/40 backdrop-blur-md hover:-translate-y-2 hover:shadow-xl transition-all duration-300 group wow animate__animated animate__fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="mb-1 text-sm font-semibold text-gray-700">MON - SAT</p>
            ...
            <a href="<?php echo e(route( (session('front_locale') ?? app()->getLocale()) . '.' . 'appointment' )); ?>"
                class="relative block p-6 sm:p-8 rounded-2xl shadow-lg border border-primary/20 bg-secondary/40 backdrop-blur-md hover:-translate-y-2 hover:shadow-xl transition-all duration-300 group wow animate__animated animate__fadeInUp" data-wow-delay="0.2s">
                ...
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="mb-1 text-sm font-semibold text-gray-700">SCHEDULE NOW</p>
                        <p class="text-xl font-bold text-primary">Quick & Easy</p>
                    </div>
                </div>
            </a>
            ...
            <!-- Contact Us Card -->
            <a href="ContactUs.html"
                class="relative block p-6 sm:p-8 rounded-2xl shadow-lg border border-primary/20 bg-secondary/40 backdrop-blur-md hover:-translate-y-2 hover:shadow-xl transition-all duration-300 group wow animate__animated animate__fadeInUp" data-wow-delay="0.3s">
                ...
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="mb-1 text-sm font-semibold text-gray-700">GET IN TOUCH</p>
                        <p class="text-xl font-bold text-primary">24/7 Support</p>
                    </div>
                </div>
            </a>
        </div>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH D:\Work\corpintech\Dr. Mai El-Hakim\resources\views/front/home/hero-section.blade.php ENDPATH**/ ?>