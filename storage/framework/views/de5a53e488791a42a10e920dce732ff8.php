    ...
    <div class="grid items-start gap-16 lg:grid-cols-2">
      ...
      <div class="order-2 lg:order-1 space-y-10">
        ...
        <div
          ...
          data-slider="1">
          <img src="<?php echo e(getLocalized($transformation->before_image)); ?>" alt="Before Treatment" class="object-cover object-bottom w-full h-80" />
          <div class="after-image">
            <img src="<?php echo e(getLocalized($transformation->after_image)); ?>" alt="After Treatment" class="object-cover object-bottom w-full h-80" />
          </div>
...
</section><?php /**PATH D:\Work\corpintech\Dr. Mai El-Hakim\resources\views/front/home/transformations.blade.php ENDPATH**/ ?>